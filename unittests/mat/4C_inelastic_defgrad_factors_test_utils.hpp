...
namespace FourC::InelasticDefgradFactorsTestUtils
{
  ...
  struct AEIParamsConfig
  {
    ...
    bool precondition_elastic_pred = true;
    double tol_precondition_elastic_pred = 1.0e-13;
  ...
  inline AEINamespace::AEIParams set_up_aei_params(const AEIParamsConfig& cfg = {})
  {
    return AEINamespace::AEIParams{
        ...
        .precondition_elastic_pred = cfg.precondition_elastic_pred,
        .tol_precondition_elastic_pred = cfg.tol_precondition_elastic_pred,

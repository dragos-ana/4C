  ...
  namespace InelasticDefgradTransvIsotropElastViscoplastUtils
  {
    ...
    class AdaptiveEstimateInterpolationManager
    {
     public:
      ...
      //! set upper interpolation bound to current interpolation point at the specified Gauss point
          ...
          std::optional<OptimalEquivStressStartingPointInput> optimal_equiv_stress_input)
      {
        ...
        switch (params_.starting_point_type)
        {
          ...
          case AdaptiveEstimateInterpolationStartingPointType::optimal_equiv_stress:
          {
            ...
            interp_point_container_.starting_points[gp] =
                calculate_optimal_equiv_stress_interp_point(optimal_equiv_stress_input.value());
     ...
     private:
      ...
      //! calculate optimal interpolation point based on the equivalent stress of the solution in
      //! relation to both predictors
      [[nodiscard]] double calculate_optimal_equiv_stress_interp_point(

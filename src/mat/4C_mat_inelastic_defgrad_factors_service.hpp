    ...
    namespace AdaptiveEstimateInterpolation
    {
      ...
      class PredictorInterpolator
      {
       public:
         ...
         * predictor
         * @param[in] preconditioning_settings settings for preconditioning the elastic predictor
        ...
        {
          //! elastic predictor: elastic eigenvalues \f$ \lambda_{\mathrm{elast}, i} \f$ for all
          //! Gauss points
          std::vector<Core::LinAlg::Matrix<3, 3>> eigenval_elast_pred;
          //! plastic predictor: elastic eigenvalues \f$ \lambda_{\mathrm{plast}, i} \f$ for all
          //! Gauss points
          ...
          //! in the first item of the Gauss point data, and all eigenvalues of the plastic
          //! predictor in the second item
       ...
       public:
        ...
        [[nodiscard]] AEIManagerState get_state() const
        {
          return {.num_plastic_pred_construct_iters = num_plastic_pred_construct_iters_,
              ...
              .interp_point_container = interp_point_container_,

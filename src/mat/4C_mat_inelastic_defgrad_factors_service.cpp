        ...
        const Core::LinAlg::Matrix<3, 3>& defgrad)
{
  ...
  /*
    if (gp == 0)
    {
      ...
      std::cout << "GP: 0: Foundation for determining optimal interpolation factors: " <<
    std::endl; std::cout << "VAL -> ELAST. PRED - PLAST. PRED: OPTIMAL" << std::endl; std::cout <<
    "lambda_1 -> " << all_pred_decomp_specific_defgrad_[gp].lambda_elast_pred_[0]

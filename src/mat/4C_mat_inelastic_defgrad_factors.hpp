...
namespace Mat
{
  ...
  */
   ...
   *
   * This class models materials in combination with the multiplicative split material that feature
   * volume changes based on a given time-dependent function for the determinant of the inelastic
   * part.
   */
   ...
   *
   * This class models materials in combination with the multiplicative split material that feature
   * anisotropic volume changes based on a given time-dependent function for the determinant of the
   * inelastic part.
   */
  class InelasticDefgradTimeFunctAniso : public InelasticDefgradTimeFunct
  {

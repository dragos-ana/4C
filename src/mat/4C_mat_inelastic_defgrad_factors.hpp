    ...
    */
    ...
    class InelasticDefgradTransvIsotropElastViscoplast : public Core::Mat::PAR::Parameter
    {
     public:
      ...
      [[nodiscard]] bool analyze_local_timint() const
      {
        return local_timint_analysis_params_.analyze_local_timint;
      };
   ...
   private:
    ...
    struct OverallState
    {
      ...
      Mat::InelasticDefgradTransvIsotropElastViscoplastUtils::AdaptiveEstimateInterpolation::
          AEIManager::AEIManagerState aei_manager_state;
    };
    ...
    [[nodiscard]] bool exhibits_plastic_flow(
     ...
     */
    [[nodiscard]] Core::LinAlg::Matrix<10, 1> interpolate_estimate(
        const InelasticDefgradTransvIsotropElastViscoplastUtils::LocalIntegrationInput&
            local_integration_input,
        InelasticDefgradTransvIsotropElastViscoplastUtils::ErrorType& err_status);
     ...
     * @param[out] err_status error status after the procedure
     */
    [[nodiscard]] double integrate_plastic_strain(
        const InelasticDefgradTransvIsotropElastViscoplastUtils::AdaptiveEstimateInterpolation::
     ...
     */
    [[nodiscard]] Core::LinAlg::Matrix<10, 1> reestimate_to_restart_local_newton(
        const Mat::InelasticDefgradTransvIsotropElastViscoplastUtils::LocalIntegrationInput&
            local_integration_input,
        InelasticDefgradTransvIsotropElastViscoplastUtils::EvaluationAction& eval_action);
     ...
     * @return updated estimate for the Local Newton scheme
     */
    [[nodiscard]] Core::LinAlg::Matrix<10, 1> reinterpolate_with_updated_bounds(
        const Mat::InelasticDefgradTransvIsotropElastViscoplastUtils::LocalIntegrationInput&
            local_integration_input,
        InelasticDefgradTransvIsotropElastViscoplastUtils::EvaluationAction& eval_action);
    ...
    void update_aei_starting_point(unsigned int gp);
    ...
    //! method
    [[nodiscard]] InelasticDefgradTransvIsotropElastViscoplastUtils::AdaptiveEstimateInterpolation::
        InputEquivStressStartingPoint
        get_input_equiv_stress_starting_point(unsigned int gp) const;

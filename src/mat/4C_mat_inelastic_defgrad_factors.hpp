  ...
  */
  ...
  class InelasticDefgradTransvIsotropElastViscoplast : public InelasticDefgradFactors
  {
   ...
   private:
    ...
    /*!
     * @brief Performs constitutive update (elastic predictor - viscoplastic / plastic corrector
     ...
     * strain
     */
    HistoryVariables constitutive_update(const Core::LinAlg::Matrix<3, 3>& FredM);

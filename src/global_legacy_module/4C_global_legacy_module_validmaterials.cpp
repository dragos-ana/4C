                ...
                {parameter<bool>("REGISTER_PLASTIC_STRAIN_INCR_OVERFLOW",
                    ...
                    parameter<double>("MAX_PLASTIC_STRAIN_INCR",
                        {.description = "maximum evaluable plastic strain increment "
                            ...
                            .validator = positive<double>()}),
                    parameter<bool>("REGISTER_PLASTIC_STRAIN_INCR_DERIVS_OVERFLOW",
                        {.description = "                                should overflow error be "
                                        "registered via ErrorType when any of the plastic strain "
                                        "derivative "
                                        "increments exceeds the specified tolerance",
                            .default_value = false}),
            ...
            group("ADAPTIVE_ESTIMATE_INTERP",
                {parameter<bool>("USE_ADAPTIVE_ESTIMATE_INTERP",
                    ...
                    parameter<double>("RELATIVE_UNDERSTRESS_TOL",
                        {.description =
                                "relative understress tolerance for $ \\overline{\\sigma} / "
                                "\\sigma_{\\text{Y}} - 1 $ used to construct the plastic predictor",
                    ...
                    parameter<double>("TOL_PRECONDITION_ELASTIC_PRED",
                        {.description = "tolerance for preconditioning the elastic "
                            ...
                            .validator = positive<double>()}),
                    parameter<bool>("BOUND_STRESS_BY_ELASTIC_PREDICTOR",
                        {.description =
                                "should the equivalent stress of estimates be capped by the "
                                "elastic predictor stress state as an upper bound, i.e. $ "
                                "\\overline{\\sigma}(\\xi) < \\overline{\\sigma}^{(\\text{E})} $?",
                            .default_value = false}),
                    ...
                    group("HARDENING_PARAMS",
                        {
                            ...
                            parameter<bool>("ALLOW_INTEGRATION_FAILURE",
                                {.description = "should failure of hardening integration "
                                                ...
                                                "thrown",
                                    .default_value = false}),
                            parameter<double>("RELATIVE_OVERSTRESS_TOL",
                                {.description = "relative overstress tolerance within the "
                                                "integration failure strategy, deciding whether "
                                                "the state shifted too much towards the elastic "
                                                "predictor or towards the plastic predictor",

...
std::shared_ptr<std::vector<std::shared_ptr<Mat::MaterialDefinition>>> Global::valid_materials()
{
  ...
  /*----------------------------------------------------------------------*/
  {
    ...
    m->add_component(parameter<std::string>("TIME_INTEGRATION_HIST_VARS",
    ...
    m->add_component(parameter<bool>(
        "USE_LINE_SEARCH", {.description = "boolean: use line search in the Local Newton Loop to "
                                           ...
                                           "(true: yes, false: no)",
                               .default_value = true}));
    m->add_component(parameter<bool>("USE_SUBSTEPPING",
    ...
    m->add_component(parameter<int>(
        "MAX_HALVE_NUM_SUBSTEP", {.description = "maximum number of times the global time step can "
                                     ...
                                     .default_value = 10}));
    m->add_component(parameter<double>("MAX_PLASTIC_STRAIN_INCR",
    ...
    m->add_component(parameter<double>("MAX_PLASTIC_STRAIN_DERIV_INCR",
        {.description =
